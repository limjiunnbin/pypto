    ...
    def _register_passes(cls):
        ...
        cls._strategy_passes = {
            OptimizationStrategy.Default: [
                ...
                ("CanonicalizeTensorOps", lambda: passes.canonicalize_tensor_ops()),
                ("InferTensorShapeLayout", lambda: passes.infer_tensor_shape_layout()),
                ("PlanTensorFusion", lambda: passes.plan_tensor_fusion()),
                ("ValidateTensorLowerability", lambda: passes.validate_tensor_lowerability()),
                ("LowerTensorToTile", lambda: passes.lower_tensor_to_tile()),
